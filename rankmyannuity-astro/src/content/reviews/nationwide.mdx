---
kind: "carrier"
title: "Nationwide Annuity Review (Pilot Scaffold)"
description: "Pilot scaffold for Nationwide, a wave-1 carrier in the Phase 5 rollout. Editorial draft pending; no subjective rankings."
...
Nationwide is a U.S. individual-annuity issuer included in the
...
rankings as the objective ordering signal; Nationwide's
...
- Nationwide Peak 10 (FIA) — see the linked product review.
...
1. LIMRA, *Fourth Quarter 2025 Top 20 Annuity Sales Rankings* —
   Nationwide ranked #7 after Athene at
   $21.92 billion in total individual-annuity sales. [1]

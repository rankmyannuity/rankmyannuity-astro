---
kind: "product"
title: "Allianz Benefit Control Review (Pilot Scaffold)"
description: "Pilot scaffold for Allianz Benefit Control, a FIA attributed to Allianz Life. Editorial draft pending; no rate data captured."
...
product:
  slug: "allianz-benefit-control"
  name: "Allianz Benefit Control"
  carrierSlug: "allianz-life"
  carrierName: "Allianz Life"
  productType: "FIA"
sources:
...
Allianz Benefit Control is a FIA product attributed to
Allianz Life in this wave-1 pilot. Product structure, crediting
...
- [Allianz Life](/reviews/allianz-life/) — carrier-level review

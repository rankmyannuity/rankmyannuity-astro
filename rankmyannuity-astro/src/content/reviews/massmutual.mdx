---
kind: "carrier"
title: "MassMutual Annuity Review (Pilot Scaffold)"
description: "Pilot scaffold for MassMutual, a wave-1 carrier in the Phase 5 rollout. Editorial draft pending; no subjective rankings."
...
MassMutual is a U.S. individual-annuity issuer included in the
...
rankings as the objective ordering signal; MassMutual's
...
- MassMutual Stable Voyage (MYGA) — see the linked product review.
...
1. LIMRA, *Fourth Quarter 2025 Top 20 Annuity Sales Rankings* —
   MassMutual ranked #8 after Athene at
   $19.68 billion in total individual-annuity sales. [1]

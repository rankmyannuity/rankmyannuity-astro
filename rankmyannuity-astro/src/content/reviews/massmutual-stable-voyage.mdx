---
kind: "product"
title: "MassMutual Stable Voyage Review (Pilot Scaffold)"
description: "Pilot scaffold for MassMutual Stable Voyage, a MYGA attributed to MassMutual. Editorial draft pending; no rate data captured."
...
product:
  slug: "massmutual-stable-voyage"
  name: "MassMutual Stable Voyage"
  carrierSlug: "massmutual"
  carrierName: "MassMutual"
  productType: "MYGA"
sources:
...
MassMutual Stable Voyage is a MYGA product attributed to
MassMutual in this wave-1 pilot. Product structure, crediting
...
- [MassMutual](/reviews/massmutual/) — carrier-level review

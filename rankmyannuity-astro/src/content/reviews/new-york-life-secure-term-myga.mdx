---
kind: "product"
title: "New York Life Secure Term MYGA Review (Pilot Scaffold)"
description: "Pilot scaffold for New York Life Secure Term MYGA, a MYGA attributed to New York Life. Editorial draft pending; no rate data captured."
...
product:
  slug: "new-york-life-secure-term-myga"
  name: "New York Life Secure Term MYGA"
...
New York Life Secure Term MYGA is a MYGA product attributed to
New York Life in this wave-1 pilot. Product structure, crediting
...
- [New York Life](/reviews/new-york-life/) — carrier-level review

---
kind: "product"
title: "Corebridge American Pathway Review (Pilot Scaffold)"
description: "Pilot scaffold for Corebridge American Pathway, a FIA attributed to Corebridge Financial. Editorial draft pending; no rate data captured."
...
product:
  slug: "corebridge-american-pathway"
  name: "Corebridge American Pathway"
...
Corebridge American Pathway is a FIA product attributed to
Corebridge Financial in this wave-1 pilot. Product structure, crediting
...
- [Corebridge Financial](/reviews/corebridge-financial/) — carrier-level review

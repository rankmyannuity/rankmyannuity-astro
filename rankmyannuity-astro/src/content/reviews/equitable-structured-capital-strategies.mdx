---
kind: "product"
title: "Equitable Structured Capital Strategies Review (Pilot Scaffold)"
description: "Pilot scaffold for Equitable Structured Capital Strategies, a RILA attributed to Equitable Financial. Editorial draft pending; no rate data captured."
...
product:
  slug: "equitable-structured-capital-strategies"
  name: "Equitable Structured Capital Strategies"
  carrierSlug: "equitable-financial"
  carrierName: "Equitable Financial"
  productType: "RILA"
sources:
...
Equitable Structured Capital Strategies is a RILA product attributed to
Equitable Financial in this wave-1 pilot. Product structure, crediting
...
- [Equitable Financial](/reviews/equitable-financial/) — carrier-level review

# Pipeline Review — 2026-04-22T20-00-01-000Z
...
> ⚠️ **FROZEN CLOCK RUN** — `PIPELINE_FROZEN_TIME=2026-04-22T20:00:01.000Z`
>
> This run used a deterministic frozen clock instead of wall-clock time. `publish-data` will refuse to promote it unless `PIPELINE_ALLOW_FROZEN_PUBLISH=1` is also set. Do NOT approve this run for production publish.
...
|-----------|-----:|:------:|:------|--------|---------|
| 5-yr MYGA (top rate) | 4.60% | `live` | 2026-04-27 | [New York Life Secure Term MVA II 5-year $100k+ rate — nylannuities.com, effective 2026-04-27](https://www.nylannuities.com/resources/rates) | `curated-yaml` |
...
Compared to `normalized-2026-04-22T20-00-00-000Z.json`.
- Added: 0
- Removed: 0
- Modified: 0
...
> No threshold breaches vs normalized-2026-04-22T20-00-00-000Z.json. Outputs structurally equivalent or within tolerance.
...
|---------|--------:|-----:|:------:|:--------|:-----------|
| `curated-yaml` | 2 | — | no | `4769fa1e9973…` | 2026-04-22T20:00:01.000Z |
| `curated-yaml` | 1 | — | no | `493d4fc8f104…` | 2026-04-22T20:00:01.000Z |
| `mdx` | 22 | — | no | `d61f1950418a…` | 2026-04-22T20:00:01.000Z |
| `fred` | 1 | — | yes | `5928a958f1d6…` | 2026-04-22T20:00:01.000Z |
| `fred` | 1 | — | yes | `1014f130b6ec…` | 2026-04-22T20:00:01.000Z |
| `treasury-direct` | 1 | — | yes | `2b8582f1dbea…` | 2026-04-22T20:00:01.000Z |
| `fdic-cd` | 1 | — | yes | `e4a809eb78c5…` | 2026-04-22T20:00:01.000Z |
